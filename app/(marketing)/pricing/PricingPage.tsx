                ...
                <div className="max-w-3xl mx-auto text-center">
                    <AnimatedSection>
                        ...
                        <p className="text-muted text-lg leading-relaxed max-w-2xl mx-auto">
                            Both tiers include the full 4-week curriculum, recorded sessions, live
...
function Logistics() {
    const notes = [
        ...
        },
        {
            ...
            answer:
                "All recorded sessions are available throughout the cohort. Live sessions are also recorded and shared afterward.",
        },
        {
