...
export default function OnboardingWizard({ role }: { role: string }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Both roles go to dashboard after onboarding
    ...
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center relative overflow-hidden text-neutral-200 font-sans selection:bg-neutral-800 selection:text-white pb-32 pt-20">
      ...
      <div className="w-full max-w-xl p-8 relative z-10">
        ...
        {step === 1 && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <p className="text-neutral-400 mb-8">
              This is how you will appear to other users across the platform.
            </p>
        ...
        {step === 2 && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h1 className="text-3xl font-semibold tracking-tight text-white mb-3">
              {isInstructor ? "Instructor Connections" : "Developer Connections"}
            </h1>
            <p className="text-neutral-400 mb-8">
              Connect your GitHub to import repositories and collaborate effectively.
            </p>
        ...
        {step === 3 && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            <h1 className="text-3xl font-semibold tracking-tight text-white mb-3">
              {isInstructor ? "Instructor Context" : "Builder Context"}
            </h1>
            <p className="text-neutral-400 mb-8">
              {isInstructor 
                ? "Let us know your experience with AI tools so we can tailor the teaching resources for you." 
