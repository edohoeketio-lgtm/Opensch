...
function WhyThisExists() {
    const reasons = [
        {
            icon: Lightbulb,
            title: "Ideas deserve better than tutorials",
            description:
        ...
        },
        {
            ...
            description:
                "You won't watch lessons and hope it sticks. Every week, you apply what you learn to your own project. Every assignment moves it forward.",
        },
        {
            icon: Users,
                        ...
                        <Card padding="large">
                            <div className="prose max-w-none">
                                ...
                                <p>
                                    ...
                                    classes with the full cohort, submit assignments that move your
